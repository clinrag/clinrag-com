        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4" aria-label="ClinRAG">
              ...
              <span className="brand-footer text-lg font-bold">ClinRAG</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/tools/clinical-rag-readiness-checker" className="hover:text-teal-400 transition-colors">Readiness Checker</Link></li>
              <li><Link href="/starter-kit" className="hover:text-teal-400 transition-colors">Starter Kit</Link></li>
              <li><Link href="/templates/evaluation-sheet" className="hover:text-teal-400 transition-colors">Evaluation Sheet</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/editorial-policy" className="hover:text-teal-400 transition-colors">Editorial Policy</Link></li>
