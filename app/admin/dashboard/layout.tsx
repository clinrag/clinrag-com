...
const navItems = [
  ...
  { label: "Tools", href: "/admin/dashboard/content", icon: "tools" },
  { label: "Guides", href: "/admin/dashboard/guides", icon: "guides" },
  { label: "Templates", href: "/admin/dashboard/templates", icon: "templates" },
  { label: "Subscribers", href: "/admin/dashboard/subscribers", icon: "subscribers" },
  { label: "Messages", href: "/admin/dashboard/messages", icon: "messages" },
];
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6 sticky top-0 z-40">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-gray-900">ClinRAG Admin</span>
        </div>
        <div className="flex items-center gap-4">
          <a href="/" target="_blank" className="text-sm text-gray-500 hover:text-teal-600">View Site →</a>
          <button
            id="logout-btn"
