  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <article className="prose-clinical">
        ...
        <ul>
          <li><strong>Full data control:</strong> When you self-host an open-source RAG system, sensitive medical data never leaves your infrastructure. There are no external API calls to third-party LLM providers or cloud services.</li>
